...
=======
		m.isBot = m?.id.startsWith('BAE5') || m?.id.startsWith('3EB0') || (m?.id.indexOf("LTS-") > 1);
...
=======
				m.quoted.isBot = m.quoted.id.startsWith('BAE5') || m.quoted.id.startsWith('HSK') || (m.id.indexOf("LTS-") > 1);
>>>>>>> 674c68d5fef13eb97000e280fe7e6567035b07c4
